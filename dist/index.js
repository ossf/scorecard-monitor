...
function loadCore () {
  if (!_corePromise) {
    _corePromise = Promise.all(/* import() */[__nccwpck_require__.e(119), __nccwpck_require__.e(260), __nccwpck_require__.e(264)]).then(__nccwpck_require__.bind(__nccwpck_require__, 7264))
  }
  return _corePromise
}
...
function loadExec () {
  if (!_execPromise) {
    _execPromise = __nccwpck_require__.e(/* import() */ 260).then(__nccwpck_require__.bind(__nccwpck_require__, 1260))
  }
  return _execPromise
}
...
function loadGithub () {
  if (!_githubPromise) {
    _githubPromise = Promise.all(/* import() */[__nccwpck_require__.e(119), __nccwpck_require__.e(157)]).then(__nccwpck_require__.bind(__nccwpck_require__, 157))
  }
...
function loadGot () {
  if (!_gotPromise) {
    _gotPromise = __nccwpck_require__.e(/* import() */ 390).then(__nccwpck_require__.bind(__nccwpck_require__, 7390)).then(m => m.default)
  }
  return _gotPromise
}
...
const { loadCore } = __nccwpck_require__(3352)
const { getProjectScore, generateIssueContent, generateReportContent, getScore, saveScore } = __nccwpck_require__(5804)
const { chunkArray } = __nccwpck_require__(4161)
...
const { loadGot } = __nccwpck_require__(2479)
const { loadCore } = __nccwpck_require__(3352)
const ejs = __nccwpck_require__(1466)
const { readFile } = (__nccwpck_require__(9896).promises)
const { join } = __nccwpck_require__(6928)
const { softAssign } = __nccwpck_require__(8718)
const databaseSchema = __nccwpck_require__(186)
const scopeSchema = __nccwpck_require__(7461)

const Ajv = __nccwpck_require__(2463)
const addFormats = (__nccwpck_require__(2815)["default"])
const ajv = new Ajv()
addFormats(ajv)
...
var utils_js_1 = __importDefault(__nccwpck_require__(9731));
/**
...
const { loadCore } = __nccwpck_require__(3352)
const { loadGithub } = __nccwpck_require__(268)
const { loadExec } = __nccwpck_require__(9402)
const { normalizeBoolean } = __nccwpck_require__(7057)
const { existsSync } = __nccwpck_require__(9896)
const { readFile, writeFile, stat, mkdir } = (__nccwpck_require__(9896).promises)
const { dirname } = __nccwpck_require__(6928)
const { isDifferent } = __nccwpck_require__(5337)
const { updateOrCreateSegment } = __nccwpck_require__(908)
const { generateScores, generateScope } = __nccwpck_require__(5105)
const { validateDatabaseIntegrity, validateScopeIntegrity } = __nccwpck_require__(5804)
